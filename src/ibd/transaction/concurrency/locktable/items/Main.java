...
public class Main {
    ...
    public void test1(ConcurrencyManager manager, String minItem, String maxItem, String toWriteItem) throws Exception {
        Table table1 = Utils.createTable2(this.path, "t1", Table.DEFULT_PAGE_SIZE, 100, false, 1);
    ...
    /*
     * public void test3(ConcurrencyManager manager, String minItem1, String
     * maxItem1,String minItem2, String maxItem2, String toWriteItem) throws
     * Exception {
     * Table table1 = Utils.createTable2(this.path, "t10",
     * Table.DEFULT_PAGE_SIZE, 100, false, 1);
     * table1.removeRecord(getValue(toWriteItem));
     * 
     * SimulatedIterations simulation = new SimulatedIterations();
     * 
    ...
    private void addTransactions(SimulatedIterations simulation, Table table1, String minItem, String maxItem)
            throws Exception {
